  ...
  return (
    <div>
      <div className="w-full aspect-[16/9] overflow-hidden">
        <img
          src="/PozeCarousel/poza19.webp"
          alt="Practica recunoștinței"
          className="w-full h-full object-cover"
        />
      </div>{" "}
      <p className="text-sm">4 oct. 2021</p>
      ...
      <p className="text-sm mt-2 truncate overflow-hidden whitespace-nowrap mb-8">
        ...
        putem folosi deloc. Exact la fel se întâmplă și cu noi, oamenii: fără
        odihnă, nu doar că nu ne simțim bine, însă nu putem fi funcționali.
      </p>
    </div>
  );
}
