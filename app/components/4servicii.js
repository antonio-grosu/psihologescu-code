...
export default function Servicii() {
  return (
    <div>
      <div className="flex flex-col items-center px-8 py-24  gap-4 bg-gray-100">
        ...
        <Link href="/servicii" className="underline">
          mai mult
        </Link>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-3 mt-12">
        <div className="flex flex-col justify-center bg-customGray gap-4 p-6 lg:py-12">
          ...
          <Link href="/servicii" className="underline text-center">
            mai mult
          </Link>
        </div>
