...
export default function Despre() {
  return (
    <div className="">
      <div className="flex flex-col items-center px-8  pt-12 pb-24 gap-4 bg-gray-100">
        <motion.img
        ...
        <div className=" mt-12 md:w-5/12 w-full">
        ...
        <h1 className="text-5xl text-customOrange mt-24 pt-8">
          despre psihologescu
        </h1>
