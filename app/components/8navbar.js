    ...
    >
      <div className="w-full px-4 sm:px-6 py-6 md:py-7 flex items-center justify-between relative flex-wrap">
        ...
        <div className="hidden md:flex md:w-3/5 w-full justify-center space-x-10 font-normal">
          <Link
            href="/"
            className="py-1 hover:text-orange-500 transition duration-200 "
          >
            acasă
          </Link>
          <Link
        ...
        <div className="flex md:w-1/5 w-full justify-end items-center gap-4 text-xl mt-4 md:mt-0">
          ...
          <div className="hidden md:flex gap-4">
            <a
              href="https://www.facebook.com/Psihologescu-105460227828929"
            ...
            <a
              href="https://www.instagram.com/psihologescu/"
              className="hover:text-orange-500 transition duration-200"
              target="_blank"
              rel="noopener noreferrer"
            >
      ...
      {menuOpen && (
        <div className="md:hidden bg-white px-6 py-5 text-sm font-normal shadow">
          <div className="flex flex-col gap-4">
            ...
            <Link href="/despre" onClick={toggleMenu}>
              despre
            </Link>
            <Link href="/echipa" onClick={toggleMenu}>
              echipa
            </Link>
            <Link href="/neurofeedback" onClick={toggleMenu}>
              neurofeedback
            </Link>
            <Link href="/servicii" onClick={toggleMenu}>
              servicii
            </Link>
