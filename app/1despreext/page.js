      ...
      <div className="mt-12 flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col gap-4 items-center m-12">
          ...
          <p className="text-center">
            ...
            psihoterapeut, și de atunci alegem cele mai eficiente metode atât
            din domeniul psihoterapiei, cât și al neuroștiințelor.
          </p>
          <p className="text-center">
          ...
          <p className="text-center">
            ...
            dintre noi. Dacă avem răbdare și puțină curiozitate vom găsi în noi
            acel ceva care ne aduce insprirație și noi resurse.
          </p>
