  ...
  return (
    <div>
      <div className="w-full aspect-[16/9] overflow-hidden">
        <img
          src="/PozeCarousel/poza25.webp"
          alt="Practica recunoștinței"
          className="w-full h-full object-cover"
        />
      </div>{" "}
      <p className="text-sm">16 sep. 2021</p>
      ...
      <p className="text-sm mt-2 truncate overflow-hidden hidden md:block whitespace-nowrap mb-8">
        ...
        denumire că ea se referă la stresul pe care îl simțim atunci când avem
        de performat, când avem ceva de făcut, de îndeplinit anumite sarcini,
        iar rezultatele sunt importante și este necesar ca acestea să fie bune.
      </p>
    </div>
  );
}
