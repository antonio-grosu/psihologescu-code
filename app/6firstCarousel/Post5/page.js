  ...
  return (
    <div>
      <div className="w-full aspect-[16/9] overflow-hidden">
        <img
          src="/PozeCarousel/poza13.webp"
          alt="Practica recunoștinței"
          className="w-full h-full object-cover"
        />
      </div>{" "}
      <p className="text-sm">12 oct. 2021</p>
      ...
      <p className="text-sm mt-2 truncate overflow-hidden hidden md:block whitespace-nowrap mb-8">
        ...
        putea suferi de o anumită condiție sau tulburare. Însă, în ultimii ani,
        în special în ultima decadă, știința a evoluat destul de mult pentru a
        oferi explicații pentru aceste comportamente etichetate ca fiind drept
        nepotrivite social, pedepsite și corectate fără eficiență.
      </p>
    </div>
  );
}
