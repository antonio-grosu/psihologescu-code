  ...
  return (
    <div>
      ...
      <p className="text-sm mt-2 truncate overflow-hidden hidden md:block whitespace-nowrap mb-8">
        ...
        suntem atât persoane separate, indivizi unici, cât și un cuplu, iar
        dansul dintre aceste două poziții este unul cât se poate de fin, care
        are mare legătură cu cu capacitatea ambilor parteneri de a păstra
        granițe sănătoase în relație.</strong>
      </p>
    </div>
  );
}
